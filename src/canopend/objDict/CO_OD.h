...
/*1400[16]  */ typedef struct{
               // 这个字段的意思是，PDO最多有00h-06h个属性，可以认为是最多几个属性
               UNSIGNED8      maxSubIndex;                      
...
/*1400[16]  */ OD_RPDOCommunicationParameter_t RPDOCommunicationParameter[16];// 16个PDO通信参数，就对应对象字典的16个entry，也就就是16个rxArray
/*1600[16]  */ OD_RPDOMappingParameter_t RPDOMappingParameter[16];
/*1800[16]  */ OD_TPDOCommunicationParameter_t TPDOCommunicationParameter[16];// 16个PDO通信参数，就对应对象字典的16个entry，也就就是16个txArray
