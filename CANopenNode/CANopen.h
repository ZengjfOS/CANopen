 ...
 */
typedef enum{
     CO_CAN_ID_NMT_SERVICE       = 0x000,   /**< 0x000 = 0b00000000000, Network management */
     CO_CAN_ID_SYNC              = 0x080,   /**< 0x080 = 0b00010000000, Synchronous message */
     CO_CAN_ID_EMERGENCY         = 0x080,   /**< 0x080 = 0b00010000000, Emergency messages (+nodeID) */
     CO_CAN_ID_TIME_STAMP        = 0x100,   /**< 0x100 = 0b00100000000, Time stamp message */
     CO_CAN_ID_TPDO_1            = 0x180,   /**< 0x180 = 0b00110000000, Default TPDO1 (+nodeID) */
     CO_CAN_ID_RPDO_1            = 0x200,   /**< 0x200 = 0b01000000000, Default RPDO1 (+nodeID) */
     CO_CAN_ID_TPDO_2            = 0x280,   /**< 0x280 = 0b01010000000, Default TPDO2 (+nodeID) */
     CO_CAN_ID_RPDO_2            = 0x300,   /**< 0x300 = 0b01100000000, Default RPDO2 (+nodeID) */
     CO_CAN_ID_TPDO_3            = 0x380,   /**< 0x380 = 0b01110000000, Default TPDO3 (+nodeID) */
     CO_CAN_ID_RPDO_3            = 0x400,   /**< 0x400 = 0b10000000000, Default RPDO3 (+nodeID) */
     CO_CAN_ID_TPDO_4            = 0x480,   /**< 0x480 = 0b10010000000, Default TPDO4 (+nodeID) */
     CO_CAN_ID_RPDO_4            = 0x500,   /**< 0x500 = 0b10100000000, Default RPDO5 (+nodeID) */
     ...
     CO_CAN_ID_HEARTBEAT         = 0x700    /**< 0x700 = 0b11100000000, Heartbeat message */
}CO_Default_CAN_ID_t;
